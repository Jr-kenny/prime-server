...
The proof uses four local provider processes with four funded Coston2 operator wallets. Provider bytes, acknowledgements, recovery writes, paid registration, provider claims, and the final payment state are live network observations. Machine-readable run records remain under `.prime-server/evidence/coston2/`.
...
The run stopped providers 2 and 4, reconstructed the object from the two surviving shards, rebuilt both missing shards, and recorded the recovery lifecycle on Flare. Key recovery transactions were:

- `startRecovery`: block `33590834`, `0xdfd91ad5c4260a176065908d7607f2be7e5e8d02ee814bc6ba42995adc560f73`
- `reassignShard`: block `33590835`, `0xef1bd3c9e2112cf7ae2579257184bbaf33b5c606468635b4cda016724c5b7f12`
- `recordRebuiltShard`: block `33590843`, `0x7899de78b8476c0f5e4e5b330a3afbda437fc01504cec544a9544e25211c43f3`
- `recordRebuiltShard`: block `33590849`, `0x28c30512ac9556728db8bc46d3eb35cb23fd2ef9099e140bde8e354628467db5`
...
- `startRecovery`: block `33591273`, `0x2a919aa7e7207be29644640f93522ed4f8ea61c7ad329a60b1cefc50ce96e66c`
- `reassignShard`: block `33591274`, `0x2d09d731e01c7485faafdf655882d4547e522b87d65121ca47e98dfefa391fd8`
- Replacement `acknowledgeShard`: block `33591280`, `0xb3a923d045f30620e7e505534c286447d7ca65c241cefd6de148820eb1b3f21a`
- `recordRebuiltShard`: block `33591281`, `0x4d09080b3d7ccd78d5f2ccdd9652000cc9bce0b9db1bc2b828c1362e09eae426`
- Replacement reserve claim: block `33591367`, `0x2a17cc6a5d969ef51728e7a745ebde5a80ffaffcd4e63d62d89f461762eee2a0`
- Final provider claim: block `33591372`, `0xcd590d742eb950fb783a3fdd212abc0c51391851d5ed982a9141e46693451c04`
