  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      <div className="page">
        ...
        {view === "providers" && <CollectionView title="Providers" eyebrow="PLACEMENT NETWORK" description="The operators Prime Server can assign shards to, with active status read from the registry." actionLabel="Store a blob" onAction={() => setUploadOpen(true)}><ProviderTable providers={data.providers} live={data.source === "coston2"}/></CollectionView>}
